...
import VotingSessionPage from "./pages/VotingSessionPage"; // Import the VotingSessionPage component
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/votes/:voteId" element={<VotingSessionPage />} /> {/* Add voting session route */}
